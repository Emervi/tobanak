...
<div class="w-11/12 mx-auto mt-10 mb-12">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.tambahCabang') }}" class="text-green-500 p-2 bg-white border border-green-500 rounded-md hover:text-white hover:bg-green-600">
    ...
    <div class="flex justify-between items-center">
        ...
        <form action="{{ route('admin.daftarCabang') }}" method="POST" class="flex gap-3">
            ...
            <input type="text" name="keyword_cabang" placeholder="Masukan nama cabang" class="bg-white p-1 shadow rounded-sm focus:outline-none">
            </div>

            {{-- tombol untuk mengembalikan pencarian seperti semula --}}
            <a href="{{ route('admin.daftarCabang') }}" class="text-blue-400 py-2 px-2 bg-white border border-blue-400 rounded-md hover:text-white hover:bg-blue-400">
        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-300">
                ...
                <td class="flex justify-evenly items-center my-3">
                    <a href="{{ route('admin.editCabang', [$cabang->id_cabang]) }}" class="text-blue-600 w-20 py-1 bg-white border border-blue-600 rounded-md text-center hover:text-white hover:bg-blue-600">
                        <i class="fas fa-pen mr-1"></i>
                        Edit
                    </a>
                    <form action="{{ route('admin.hapusCabang', [$cabang->id_cabang]) }}" method="POST">
                        @csrf
                        @method('delete')
