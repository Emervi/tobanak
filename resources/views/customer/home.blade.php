...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-5">
    ...
    <a href="{{ route('customer.keranjang') }}" class="bg-white m-5 fixed bottom-5 right-1 border border-green-500 text-green-500 p-3 rounded-full shadow-lg hover:bg-green-500 hover:text-white">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        var notifBtnKeranjang = $('a[href="{{ route('customer.keranjang') }}"]');
                        if (totalJumlah > 0) {
