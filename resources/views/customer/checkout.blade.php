                ...
                <div class="flex-1 p-3 rounded-lg">
                    <div class="flex flex-col h-full">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <input type="radio" id="cod" name="payment" class="hidden peer/cod" value="COD">
                            <label for="cod"
                            ...
                            <input type="radio" id="transfer" name="payment" class="hidden peer/transfer" value="transfer">
                            <label for="transfer"
        ...
        <div x-show="isOpenAddress" x-cloak
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
                ...
                <form>
                    ...
                    <div class="mb-4">
                        <label for="address" class="block text-sm font-medium text-gray-700">Provinsi, Kota, Kecamatan,
                            Kode Pos</label>
                    ...
                    <div class="mb-4">
                        <label for="street" class="block text-sm font-medium text-gray-700">Nama Jalan, Gedung, No.
                            Rumah</label>
                    ...
                    <div class="mb-4">
                        <label for="details" class="block text-sm font-medium text-gray-700">Detail Lainnya (Cth: Blok /
                            Unit No., Patokan)</label>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex space-x-4">
                            <button type="button"
                                class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 rounded-md">Rumah</button>
                            <button type="button"
                                class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 rounded-md">Kantor</button>
                        </div>
                    </div>
