    ...
    <div class="w-1/3 bg-white mx-auto p-5 rounded-md shadow-xl mt-12">
        ...
        <form action="{{ url('/register') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" maxlength="35" class="w-full border border-gray-300 rounded-md p-2 focus:outline-none focus:ring focus:ring-blue-300">
                @error('name')
                <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
