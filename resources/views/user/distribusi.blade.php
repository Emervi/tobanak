                    ...
                    <tr class="hover:bg-gray-300">
                        ...
                        <td class="p-2">
                            <div class="flex items-center justify-center gap-2">
                                <form action="{{ route('distribusi.updateStatus', $barang->id_barang) }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="status" value="Diterima">
                                    <button type="submit" class="text-green-600 w-20 py-1 bg-white border border-green-600 rounded-md text-center hover:text-white hover:bg-green-600">
                                        Terima
                                    </button>
                                </form>
                                <form action="{{ route('distribusi.updateStatus', $barang->id_barang) }}" method="POST">
                                    ...
                                    <button type="submit" class="text-red-600 w-20 py-1 bg-white border border-red-600 rounded-md text-center hover:text-white hover:bg-red-600">
                                        Tolak
                                    </button>
                                </form>                                
                            </div>
